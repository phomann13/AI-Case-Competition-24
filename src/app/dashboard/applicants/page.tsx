...
export const metadata = { title: `Applicants | Dashboard ` } satisfies Metadata;
...
const customers = [
  ...
  },
  {
    ...
    createdAt: dayjs().subtract(20, 'hours').toDate(),
  },
  {
    id: 'PMN-005',
    name: 'Fran Perez',
    ...
    createdAt: dayjs().subtract(43, 'hours').toDate(),
  },

  {
    ...
    createdAt: dayjs().subtract(56, 'hours').toDate(),
  },
  {
    id: 'PMN-003',
    name: 'Carson Darrin',
    ...
    createdAt: dayjs().subtract(82, 'hours').toDate(),
  },
  {
    id: 'PMN-002',
  ...
  },
  {
    ...
    createdAt: dayjs().subtract(100, 'hours').toDate(),
  },
] satisfies Customer[];
